...
export interface ApiConsegnaConsegna extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    Dimensione_Pacco: Schema.Attribute.String;
    Email: Schema.Attribute.Email;
...
export interface ApiMapConfigMapConfig extends Struct.SingleTypeSchema {
  ...
  info: {
    ...
    pluralName: 'map-configs';
    singularName: 'map-config';
  };
  options: {
  ...
  attributes: {
    ...
    radius: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        ...
        number
      > &
      Schema.Attribute.DefaultTo<7500>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    Stato: Schema.Attribute.Enumeration<
      ['Ritirato', 'In consegna', 'Consegnato', 'In attesa', 'In arrivo']
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    Indirizzo_sede: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'plugin::users-permissions.user'
    ...
    tipo_cliente: Schema.Attribute.Enumeration<['privato', 'azienda']> &
      Schema.Attribute.DefaultTo<'privato'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    username: Schema.Attribute.String &
